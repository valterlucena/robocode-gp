...
Importa arquivos de teste
```{r, warning=FALSE, message=FALSE}
tudo_crossover <- read.csv(here("data/run_data_crossover.csv"))
tudo_50 <- read.csv(here("data/run_data.csv"))
...
- Primeira mudança: crossover

```{r, warning=FALSE, message=FALSE}
tudo_50$opponent <- "test_all"
tudo_crossover$opponent <- "test_crossover"

test <- rbind(tudo_50, tudo_crossover)
```
